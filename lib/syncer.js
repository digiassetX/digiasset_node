...
const lookForNewAssets=async()=>{
    ...
    try {
        ...
        consolePrinter("Got CID list for height: "+lastHeight);
    } catch (e) {
        consolePrinter("Could not get CID list");
...
(async()=> {
    ...
    console.log("\x1b[32mIPFS Connected\x1b[0m");
